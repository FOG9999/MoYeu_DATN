...
/**
 * Biá»ƒu diá»…n chromosome. Chromosome mÃ£ hÃ³a thÃ´ng tin cá»§a testcase
 * <p>
 * Examples:
 * <p>
...
public class Chromosome implements Comparable, Cloneable {
    /**
     * Testcase : List hÃ m hoáº·c constructor
     */
    ...
    /**
     * Branch targets Ä‘Æ°á»£c bao phá»§
     */
    private Path coveredPath;

    /**
     * Ä�Æ°á»�ng dáº«n Ä‘Æ°á»£c bao phá»§ bá»Ÿi TestCaseExecutor.
     */
    ...
    /**
     * Branch targets Ä‘Æ°á»£c bao phá»§ ( chá»‰ xÃ©t trong method hiá»‡n táº¡i)
     */
    private Path targetPath;

    /**
     * Target Ä‘Æ°á»£c thá»�a mÃ£n bá»Ÿi TestCaseExecutor.
     */
    ...
    /**
     * Sá»‘ branch Ä‘Æ°á»£c bao phá»§ Ä‘áº¿n hiá»‡n táº¡i bá»Ÿi chromosome
     */
    ...
    /**
     * káº¿t quáº£ tráº£ vá»� cá»§a method
     */
    ...
    /**
     * Sáº¯p xáº¿p chromosome dá»±a trÃªn Ä‘á»™ giáº£m giÃ¡ trá»‹ fitness
     */
...
//     *
//     * @param objId object Target cá»§a constructor.
//     * @return ConstructorInvocation object cá»§a objId .
//     */
...
//    }
    ...
    /**
     * xáº­y dá»±ng chromosome tá»« cÃ¡c action
     */
    ...
    /**
     * Láº¥y ra list cÃ¡c value cá»§a chromosome
     *
     * @return actualParams List cÃ¡c value
     */
...
//    } 
    ...
    /**
     * Set giÃ¡ trá»‹ value cho action
     *
     * @param newValue list giÃ¡ trá»‹ má»›i
     */
...
//    }
    ...
    /**
     * XÃ¡c Ä‘á»‹nh biáº¿n $xN Ä‘Æ°á»£c gÃ¡n cho obj cá»§a 1 class tá»« class Ä‘Ã£ biáº¿t
     * <p>
     * Scan chromosome cho tá»›i khi gáº·p Ä‘á»‘i tÆ°á»£ng cá»§a 1 class. left hand side
     * variable Ä‘Æ°á»£c tráº£ vá»�
     *
     * @param className class cá»§a Ä‘á»‘i tÆ°á»£ng tÃ¬m kiáº¿m
     * @return String Ä‘áº¡i diá»‡n cá»§a biáº¿n Ä‘á»‘i tÆ°á»£ng tÃ¬m kiáº¿m (hoáº·c null)
     */
    ...
    /**
     * XÃ¡c Ä‘á»‹nh biáº¿n $xN Ä‘Æ°á»£c gÃ¡n cho obj cá»§a 1 class tá»« list class Ä‘Ã£ biáº¿t
     *
     * @param classes Danh sÃ¡ch cÃ¡c lá»›p Ä‘á»‘i tÆ°á»£ng cÃ³ thá»ƒ thuá»™c vá»�
     * @return String Ä‘áº¡i diá»‡n cá»§a biáº¿n Ä‘á»‘i tÆ°á»£ng tÃ¬m kiáº¿m (hoáº·c null)
     */
    ...
    /**
     * Adds action Ä‘á»ƒ mÃ´ táº£ input
     *
     * @param act Action Ä‘Æ°á»£c add
     */
...
//        	actualValues.addAll(actualValuesOfAStatement);
     ...
     *
     * @param chrom Chromosome sau khi Ä‘Æ°á»£c ghÃ©p
     */
